// ============================================
// QuizHub — Ежедневные события v2.1
...
function checkActiveEvent() {
    ...
    // Проверяем специальные события (приоритет)
...
function scheduleMidnightRefresh() {
    ...
    const msUntilMidnight = midnight.getTime() - mskTime.getTime();

    console.log(`🕐 События обновятся через ${Math.floor(msUntilMidnight / 1000 / 60)} минут`);

    setTimeout(() => {
        console.log('🕐 Полночь! Обновляем события...');
        renderEventBanner();
